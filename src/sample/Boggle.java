...
public class Boggle extends Observable {
    ...
    private List<String> motsDejaChoisis;
    ...
    public Boggle(int taille) {
        ...
        motsDejaChoisis = new ArrayList<String>();
        this.ligneChoisie = -1 ;
    ...
    public List<String> getMotsDejaChoisis(){return this.motsDejaChoisis;}
    ...
    public void valider() {
        ...
        if (dico.contient(mot.toString()) && !motsDejaChoisis.contains(mot.toString())) {
            this.score += this.mot.length();
            motsDejaChoisis.add(mot.toString());
        }
        else
            this.score -= 1 ;
        this.mot = new StringBuilder("");
